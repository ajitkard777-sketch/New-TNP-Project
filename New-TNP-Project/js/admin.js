...
function handleAdminModalSubmit(e, actionType) {
    ...
    if (actionType === "add-company") {
        ...
        if (document.getElementById("company-search")) renderCompaniesManagement(document.getElementById("main-content"));
...
function openJobDetails(jobId) {
    ...
    if (!job) return;
    app.showToast(`Viewing: ${job.title} at ${job.companyName}`, "info");
}
