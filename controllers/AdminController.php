...
class AdminController {
    ...
    public function trainingEnrollments(): void {
        ...
        if ($search) {
            $where .= " AND (s.first_name LIKE ? OR s.last_name LIKE ? OR s.enrollment_no LIKE ? OR t.title LIKE ? OR u.email LIKE ?)";
        ...
        $sql = "SELECT tr.*, 
                       ...
                       s.id as student_id, s.first_name, s.last_name, s.enrollment_no, s.branch, s.passing_year, s.admission_year, s.degree, s.phone, s.resume_path, s.profile_photo,
