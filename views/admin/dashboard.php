...
<div class="row g-4 mb-3">
    <div class="col-xl-2 col-lg-4 col-sm-6">
        <a href="<?= url('/admin/students') ?>" class="stat-card-link">
    ...
    <div class="col-xl-2 col-lg-4 col-sm-6">
        <a href="<?= url('/admin/students?status=placed') ?>" class="stat-card-link">
    ...
    <div class="col-xl-2 col-lg-4 col-sm-6">
        <a href="<?= url('/admin/companies') ?>" class="stat-card-link">
    ...
    <div class="col-xl-2 col-lg-4 col-sm-6">
        <a href="<?= url('/admin/jobs') ?>" class="stat-card-link">
    ...
    <div class="col-xl-2 col-lg-4 col-sm-6">
        <a href="<?= url('/admin/placements') ?>" class="stat-card-link">
    ...
    <div class="col-xl-2 col-lg-4 col-sm-6">
        <a href="<?= url('/admin/placements') ?>" class="stat-card-link">
            <div class="stat-card gradient-danger">
                <div class="stat-card-icon bg-danger-soft"><i class="fas fa-chart-line"></i></div>
                <div class="stat-card-value"><?= $averagePackage ? number_format($averagePackage, 1) : '0' ?></div>
                <div class="stat-card-label">Average LPA</div>
            </div>
        </a>
    </div>
</div>
    ...
    <div class="col-lg-4 col-md-4">
        <a href="<?= url('/admin/students') ?>" class="stat-card-link">
            <div class="stat-card gradient-primary">
                ...
                <div class="stat-card-value"><?= $appliedStudentsCount ?></div>
                <div class="stat-card-label">Students Applied for Jobs</div>
            </div>
        </a>
    </div>
    <div class="col-lg-4 col-md-4">
        <a href="<?= url('/admin/trainings') ?>" class="stat-card-link">
            <div class="stat-card gradient-violet">
                <div class="stat-card-icon bg-violet-soft"><i class="fas fa-chalkboard-teacher"></i></div>
                <div class="stat-card-value"><?= $trainingEnrolledCount ?></div>
                <div class="stat-card-label">Students Enrolled in Training</div>
            </div>
        </a>
    </div>
    <div class="col-lg-4 col-md-4">
        <a href="<?= url('/admin/higher-studies') ?>" class="stat-card-link">
            <div class="stat-card gradient-danger">
                ...
                <div class="stat-card-label">Students Registered for Higher Studies</div>
            </div>
        </a>
    </div>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-4">
            <div class="card-header"><h6><i class="fas fa-tasks me-2 text-info"></i>Student Career Tracks &amp; Academic Engagement</h6></div>
            <div class="card-body"><div class="chart-container"><canvas id="engagementChart" height="250"></canvas></div></div>
        </div>
