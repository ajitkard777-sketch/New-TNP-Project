...
<div class="content-header">
    <div>
        ...
        <p class="subtitle">Create a complete job posting for campus recruitment. All fields are mandatory.</p>
    </div>
    <a href="<?= url('/company/jobs') ?>" class="btn btn-light btn-sm"><i class="fas fa-arrow-left me-1"></i> Back to Jobs</a>
</div>

<form action="<?= url('/company/post-job') ?>" method="POST" data-tpms-validate id="postJobForm">
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" name="title" id="job_title"
                           ...
                           value="<?= htmlspecialchars($oldInput['title'] ?? '') ?>" required
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="job_type" id="job_type" required data-validate-rule="text" data-validate-label="Job type">
                        ...
                        <option value="<?= $k ?>" <?= ($oldInput['job_type'] ?? '') === $k ? 'selected' : '' ?>><?= $v ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div class="invalid-feedback"></div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="work_mode" id="work_mode" required data-validate-rule="text" data-validate-label="Work mode">
                        <option value="onsite" <?= ($oldInput['work_mode'] ?? 'onsite') === 'onsite' ? 'selected' : '' ?>>On-site</option>
                        <option value="remote" <?= ($oldInput['work_mode'] ?? '') === 'remote' ? 'selected' : '' ?>>Remote</option>
                        <option value="hybrid" <?= ($oldInput['work_mode'] ?? '') === 'hybrid' ? 'selected' : '' ?>>Hybrid</option>
                    </select>
                    <div class="invalid-feedback"></div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="location" id="job_location"
                           ...
                           value="<?= htmlspecialchars($oldInput['location'] ?? '') ?>" required
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" name="openings" id="job_openings"
                           ...
                           value="<?= htmlspecialchars($oldInput['openings'] ?? '1') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="salary_min" id="salary_min"
                           ...
                           value="<?= htmlspecialchars($oldInput['salary_min'] ?? '') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="salary_max" id="salary_max"
                           ...
                           value="<?= htmlspecialchars($oldInput['salary_max'] ?? '') ?>" required
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" name="application_deadline" id="application_deadline"
                           min="<?= date('Y-m-d') ?>"
                           value="<?= htmlspecialchars($oldInput['application_deadline'] ?? '') ?>" required
                           data-validate-rule="date" data-validate-label="Application deadline">
                    <div class="invalid-feedback"></div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" name="joining_date" id="joining_date"
                           min="<?= date('Y-m-d') ?>"
                           value="<?= htmlspecialchars($oldInput['joining_date'] ?? '') ?>" required
                           data-validate-rule="date" data-validate-label="Expected joining date">
                    <div class="invalid-feedback"></div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="qualification" id="job_qualification"
                           ...
                           value="<?= htmlspecialchars($oldInput['qualification'] ?? '') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="eligibility_branches" id="eligibility_branches"
                           ...
                           value="<?= htmlspecialchars($oldInput['eligibility_branches'] ?? '') ?>"
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="passing_year" id="passing_year"
                           ...
                           value="<?= htmlspecialchars($oldInput['passing_year'] ?? date('Y')) ?>" required
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" name="eligibility_cgpa" id="eligibility_cgpa"
                           ...
                           value="<?= htmlspecialchars($oldInput['eligibility_cgpa'] ?? '0.00') ?>" required
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" name="eligibility_backlogs" id="eligibility_backlogs"
                           ...
                           value="<?= htmlspecialchars($oldInput['eligibility_backlogs'] ?? '0') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="experience_required" id="experience_required"
                           ...
                           value="<?= htmlspecialchars($oldInput['experience_required'] ?? 'Freshers') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="skills_required" id="skills_required"
                           ...
                           value="<?= htmlspecialchars($oldInput['skills_required'] ?? '') ?>" required
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="selection_process" id="selection_process" rows="3"
                              ...
                              required data-validate-rule="text" data-validate-label="Selection process" data-validate-min="10" data-validate-max="1000"><?= htmlspecialchars($oldInput['selection_process'] ?? '') ?></textarea>
                    <div class="invalid-feedback"></div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="description" id="job_description" rows="6"
                              ...
                              data-maxlength="2000" data-maxlength-target="desc_counter"><?= htmlspecialchars($oldInput['description'] ?? '') ?></textarea>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="invalid-feedback"></div>
                        <small class="text-muted ms-auto" id="desc_counter"><?= mb_strlen($oldInput['description'] ?? '') ?>/2000</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="contact_person" id="contact_person"
                           ...
                           value="<?= htmlspecialchars($oldInput['contact_person'] ?? $company['contact_person'] ?? '') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" class="form-control" name="contact_email" id="contact_email"
                           ...
                           value="<?= htmlspecialchars($oldInput['contact_email'] ?? $company['contact_email'] ?? '') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="contact_phone" id="contact_phone"
                           ...
                           value="<?= htmlspecialchars($oldInput['contact_phone'] ?? $company['contact_phone'] ?? '') ?>" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" class="form-control" name="website" id="company_website"
                           ...
                           value="<?= htmlspecialchars($oldInput['website'] ?? $company['website'] ?? '') ?>" required
