    ...
    <div class="row g-3">
        ...
        <div class="col-md-8">
            ...
            <div class="input-group">
                <input type="number" class="form-control" name="salary_min" step="0.1" min="0" placeholder="Min LPA e.g. 4.5">
                <span class="input-group-text fw-bold">–</span>
                <input type="number" class="form-control" name="salary_max" step="0.1" min="0" placeholder="Max LPA e.g. 12">
                <span class="input-group-text text-muted">LPA</span>
            </div>
            <small class="text-muted" style="font-size:0.78rem">Example: 4.5 – 12 means 4.5 to 12 Lakhs Per Annum. Leave blank if not disclosed.</small>
        </div>
