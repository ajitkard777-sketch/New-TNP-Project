...
<div class="content-header mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
    <div>
        <h1 class="page-title mb-1"><i class="fas fa-bell text-primary me-2"></i>Company Notification Center</h1>
        <p class="subtitle mb-0">Alerts on student applications, interview updates, and system announcements</p>
    </div>
            ...
            <div class="col-md-5 col-lg-4">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <select id="notifCategoryFilter" class="form-select form-select-sm">
                        ...
                        <option value="job">Jobs & Drives</option>
                        <option value="interview">Interviews</option>
                        <option value="placement">Applications</option>
...
<div class="card shadow-sm border-0" id="notifEmptyState">
    <div class="card-body text-center p-5">
        ...
        <p class="text-muted small mb-0">You are all caught up! Updates will appear here.</p>
    </div>
</div>
<?php else: ?>
        ...
        <div class="list-group list-group-flush" id="notifListContainer">
            ...
            <?php
                ...
                if ($categoryLower === 'job' || str_contains($titleLower, 'job') || str_contains($titleLower, 'opening') || str_contains($titleLower, 'post')) {
                    ...
                    $matchedCat = 'job';
                } elseif ($categoryLower === 'placement' || str_contains($titleLower, 'application') || str_contains($titleLower, 'status') || str_contains($titleLower, 'shortlist')) {
                ...
                } elseif (str_contains($titleLower, 'message') || str_contains($titleLower, 'chat')) {
